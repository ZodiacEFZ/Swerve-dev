...
public class Chassis extends Zwerve {
    ...
    private static final TalonFXSwerve front_left = new TalonFXSwerve(5, 1, 9, 3352).invert(false, true, false);
    private static final TalonFXSwerve front_right = new TalonFXSwerve(8, 4, 12, 1908).invert(true, true, false);
    private static final TalonFXSwerve rear_left = new TalonFXSwerve(6, 2, 10, 693).invert(false, true, false);
    private static final TalonFXSwerve rear_right = new TalonFXSwerve(7, 3, 11, 162).invert(true, true, false);
